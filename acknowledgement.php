...
<head>
    ...
    <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" id="font-awesome">
    <link rel="stylesheet" href="stylesheets/style.css">
</head>
<body style="background-image:url(public/bg-image.jpg)">
    ...
    <div class="row text-center">
        ...
        <div class="col-xl-4 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="public/dipanshu.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                ...
                <br>
                <span class="small text-uppercase text-muted">BTech <br> IIT Mandi <br> </span>
                <ul class="social mb-0 list-inline mt-3">
        ...
        <div class="col-xl-6 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="public/varun.jpeg" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                ...
                <br>
                <span class="small text-uppercase text-muted">Associate Professor <br> IIT Mandi</span>
